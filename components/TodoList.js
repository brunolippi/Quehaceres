...
export default class TodoList extends React.Component {
    ...
    Alert.alert(
      "Atencion!",
      "Estas por borrar esta lista PERMANENTEMENTE.",
      [
        { text: "OK", onPress: () => this.deleteList() },
        {
          text: "Cancelar",
    ...
    render() {
        ...
        <View>
            ...
            <TouchableOpacity style={[styles.listContainer, { backgroundColor: list.color }]} onPress={() => this.toggleListModal()} onLongPress={() => this.Alerta()}>
